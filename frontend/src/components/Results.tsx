      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="border border-orange-300 shadow-md">
          <CardContent className="p-6 space-y-8">
            {/* Header, style, description and graph section */}
            ...
            {/* Preference Section - Individual cards without inner blue cards */}
            ...
            <Card className="border border-orange-300 shadow-md">
              <CardHeader>
                <CardTitle className="text-primary">Collaboration Guide</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold mb-4 text-primary">Working with Others</h3>
                  ...
                  <Card className="border border-orange-200">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground whitespace-pre-line">
                        {results.detailed_profile.working_relationships.intuitives}
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border border-orange-200">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground whitespace-pre-line">
                        {results.detailed_profile.working_relationships.conceptuals}
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border border-orange-200">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground whitespace-pre-line">
                        {results.detailed_profile.working_relationships.pragmatists}
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border border-orange-200">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground whitespace-pre-line">
                        {results.detailed_profile.working_relationships.deductives}
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <div className="flex justify-center space-x-4">
              <Button onClick={handlePrint} variant="outline" className="border-[#016D77] text-primary hover:bg-[#016D77] hover:text-white">
                Print Results
              </Button>
              <Button onClick={() => window.location.href = '/'} variant="outline" className="border-[#016D77] text-primary hover:bg-[#016D77] hover:text-white">
                Start Over
              </Button>
            </div>
          </CardContent>
